...
Differences I found:
- Java has the public state with `public static void main()` inside the the first line of the class.
- Java requires brackets and curly braces instead of colon for 'for' loop when using looping
- Java requires specifications of syntax, i.e., boolean, String
- Every line in Java requires a ; at the end
- Instead of `print('Hello World!')` in Python, Java uses `System.out.println("Fizz Buzz")`.
